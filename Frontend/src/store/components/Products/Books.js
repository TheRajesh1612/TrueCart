...
const Books = () => {
  ...
  const selectedItem = booksData.find((item) => item.id === showCard);

  return (
    <>
      <div className=" w-full h-full">
        <h3 className="px-4 pt-2 font-serif font-light">Books</h3>
        <motion.div
            ...
            >
              ...
              >
                ...
                <div className="p-2">
                  ...
                  <p className=" font-sans italic">{selectedItem.author}</p>
