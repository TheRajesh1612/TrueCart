...
const FridgesPage = () => {
  ...
  // Filtered fridges data based on selected companies
  const filteredProduct =
    selectProduct.length === 0
      ? fridgeData
      : fridgeData.filter((item) => selectProduct.includes(item.brand));
        ...
        <div className=" flex flex-col lg:flex-row">
          ...
          >
            <h2 className=" text-sm font-sans text-decoration-underline py-3 text-gray-500 p-1 m-0">
              Explore Our fridges Collection
            </h2>
            {/* Filter Options */}
