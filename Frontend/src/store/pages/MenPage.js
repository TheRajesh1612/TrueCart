...
const MenPage = () => {
  ...
  // Filtered men data based on selected companies
  const filteredProduct =
    selectProduct.length === 0
      ? menData
      : menData.filter((item) => selectProduct.includes(item.brand));
