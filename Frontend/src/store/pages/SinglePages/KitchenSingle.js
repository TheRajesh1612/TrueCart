    ...
    <>
      ...
      <div className="min-h-screen py-5 px-2">
        <div className="flex justify-center items-center">
          <div className="flex flex-col md:flex-row rounded-xl shadow-3xl max-w-[900px] bg-white overflow-hidden">
            {/* Product image */}
            ...
            <div className="p-6 flex flex-col gap-3 justify-center">
              ...
              <button 
                className="bg-orange-600 rounded py-2 px-4 text-white text-md font-sans max-w-[400px] hover:bg-orange-700 transition"
