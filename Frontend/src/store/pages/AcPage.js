...
const AcPage = () => {
  ...
  // Filtered Ac data based on selected companies
  const filteredProduct =
    selectProduct.length === 0
      ? acData
      : acData.filter((item) => selectProduct.includes(item.company));
    ...
    <>
      ...
      <div className="  flex flex-col min-h-screen bg-gray-200">
        ...
        <div className=" flex flex-col lg:flex-row">
          ...
          <div className=" fixed bg-slate-900 backdrop-blur-lg block lg:hidden rounded-tr rounded-br p-1">
            <MotionLink
              className="no-underline flex gap-1 items-center text-white backdrop:blur-lg rounded  hover:bg-slate-800 transition"
